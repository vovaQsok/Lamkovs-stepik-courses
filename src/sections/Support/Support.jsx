    ...
    return (
        ...
        >
            <div className="support__body">
                <div className="support__info">
                    <h1
                        ...
                        id={titleId}>Welcome to our support page!
                    </h1>
                    <div className="support__description">
                        <p>We're here to help you with any problems you may be having with our product.
                        </p>
                    </div>
                </div>
                <Image
            ...
            <form className="support__form" action="">
                ...
                />
                <Field
                    className="support__form-cell support__form-cell"
                    label="Email"
                    type="email"
                ...
                />
                <Field
                    className="support__form-cell--wide"
                    label="Message"
                    type="textarea"
                    placeholder="Hi! Ihave a question..."
                    isRequired
                />
                <div className="support__form-cell support__form-cell--wide support__form-cell--actions">
                    <Checkbox
                        classNmae="support__form-agreement"
